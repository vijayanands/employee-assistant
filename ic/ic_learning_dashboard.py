...
import pandas as pd
from ui.style import create_styled_tabs, create_progress_bar, create_pie_chart, display_pie_chart, apply_styled_dropdown_css
...
def learning_status_tab():
    ...
    with col2:
        ...
        courses = [
            ...
            {"name": "Data Analysis with Pandas", "progress": 75, "status": "In Progress"},
            {"name": "Machine Learning Fundamentals", "progress": 50, "status": "In Progress"},
            {"name": "Advanced SQL", "progress": 100, "status": "Completed"},
            {"name": "Cloud Computing Essentials", "progress": 0, "status": "Not Started"}
        ]
...
def courses_tab():
    courses = [
        {"name": "Python Basics", "status": "Completed", "completion_date": "2024-03-15"},
        {"name": "Data Analysis with Pandas", "status": "In Progress", "expected_completion": "2024-10-30"},
        {"name": "Machine Learning Fundamentals", "status": "In Progress", "expected_completion": "2024-11-15"},
        {"name": "Advanced SQL", "status": "Completed", "completion_date": "2024-05-01"},
        {"name": "Cloud Computing Essentials", "status": "Not Started", "start_date": "2024-12-01"},
        {"name": "Web Development with Django", "status": "Not Started", "start_date": "2025-01-15"},
        {"name": "Data Visualization with Matplotlib", "status": "Not Started", "start_date": "2025-02-01"}
    ]
...
def compliance_tab():
    compliance_courses = [
        {"name": "Data Privacy and Security", "status": "Completed", "due_date": "2024-06-30", "completion_date": "2024-06-15"},
        {"name": "Workplace Ethics", "status": "In Progress", "due_date": "2024-11-15", "progress": 60},
        {"name": "Health and Safety", "status": "Not Started", "due_date": "2024-12-31"}
    ]
...
def learning_opportunities_tab():
    ...
    with col1:
        category = st.selectbox("Category", ["All", "Programming", "Data Science", "Cloud Computing"])
    with col2:
        date_range = st.date_input("Date Range", [datetime.date(2024, 1, 1), datetime.date(2024, 12, 31)])
