...
def director_executive_summary_dashboard():
    ...
    with col1:
        create_styled_metric("Overall Productivity Score", kpi_data['productivityScore'], "📈")
        create_styled_metric("Turnover Rate", kpi_data['turnoverRate'], "🔄")
    with col2:
        create_styled_metric("Performance Index", str(kpi_data['performanceIndex']), "🎯")
    ...
    with tabs[0]:
        ...
        with col1:
            ...
            create_styled_line_chart(df['turnover'].tolist(), "Date", "Turnover Rate (%)")
            trend_info = [
        ...
        with col2:
            ...
            create_styled_line_chart(df['engagement'].tolist(), "Date", "Engagement Score")
            engagement_info = [
            ...
            create_styled_bullet_list(engagement_info, "Engagement Score Interpretation")
    ...
    with tabs[1]:
        ...
        if selected_kpi in team_data:
            ...
            create_styled_bar_chart(team_df['team'], team_df['score'], "Team", selected_kpi)
            st.table(team_df)
