...
import pandas as pd
from ui.style import create_styled_tabs, create_styled_bar_chart, create_styled_bullet_list

# Anonymized engagement data
anonymized_engagement_data = [
    {"id": "EMP001", "workLifeBalance": 7, "jobSatisfaction": 8, "teamCollaboration": 9, "careerGrowth": 6},
    {"id": "EMP002", "workLifeBalance": 6, "jobSatisfaction": 7, "teamCollaboration": 8, "careerGrowth": 7},
    {"id": "EMP003", "workLifeBalance": 8, "jobSatisfaction": 6, "teamCollaboration": 7, "careerGrowth": 8},
    {"id": "EMP004", "workLifeBalance": 5, "jobSatisfaction": 7, "teamCollaboration": 9, "careerGrowth": 6},
    {"id": "EMP005", "workLifeBalance": 7, "jobSatisfaction": 8, "teamCollaboration": 6, "careerGrowth": 7},
]

# Employee compliance data
employee_compliance_data = [
    {"name": "Alice", "safetyTraining": "compliant", "dataProtection": "compliant", "codeOfConduct": "compliant"},
    {"name": "Bob", "safetyTraining": "non-compliant", "dataProtection": "compliant", "codeOfConduct": "compliant"},
    {"name": "Charlie", "safetyTraining": "compliant", "dataProtection": "warning", "codeOfConduct": "compliant"},
    {"name": "Diana", "safetyTraining": "compliant", "dataProtection": "compliant", "codeOfConduct": "non-compliant"},
    {"name": "Ethan", "safetyTraining": "warning", "dataProtection": "compliant", "codeOfConduct": "compliant"},
]
...
def display_engagement_metrics():
    ...
    categories = ["workLifeBalance", "jobSatisfaction", "teamCollaboration", "careerGrowth"]
...
def display_compliance_status():
    ...
    styled_df = df.style.applymap(color_status, subset=["safetyTraining", "dataProtection", "codeOfConduct"])
